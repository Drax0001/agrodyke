  ...
  return (
    <div className="rounded-2xl border border-green-200 bg-green-50 p-8 shadow-sm text-center">
      ...
      <p className="mt-2 text-sm text-green-800">
        {t("checkout.whatsapp.message")}
      </p>

      <button
        type="button"
        onClick={onReturn}
        className="mt-8 rounded-full bg-green-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-green-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
      >
